...
namespace App\Http\Requests\Backend\ChargeAndCollectionSummary;

use Illuminate\Foundation\Http\FormRequest;

class ManageChargeAndCollectionSummaryRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-chargeandcollectionsummary');
    }
