...
namespace App\Http\Requests\Backend\ChargeDetailReport;

use Illuminate\Foundation\Http\FormRequest;

class ManageChargeDetailReportRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-chargedetailreport');
    }
