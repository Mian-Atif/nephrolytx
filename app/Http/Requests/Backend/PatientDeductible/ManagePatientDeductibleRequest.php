...
namespace App\Http\Requests\Backend\PatientDeductible;

use Illuminate\Foundation\Http\FormRequest;

class ManagePatientDeductibleRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-patientdeductible');
    }
