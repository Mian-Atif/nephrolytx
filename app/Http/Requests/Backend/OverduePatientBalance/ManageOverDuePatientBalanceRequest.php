...
namespace App\Http\Requests\Backend\OverduePatientBalance;

use Illuminate\Foundation\Http\FormRequest;

class ManageOverDuePatientBalanceRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('aging-summary');
    }
