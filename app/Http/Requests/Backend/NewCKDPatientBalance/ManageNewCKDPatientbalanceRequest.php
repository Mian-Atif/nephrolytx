...
namespace App\Http\Requests\Backend\NewCKDPatientBalance;

use Illuminate\Foundation\Http\FormRequest;

class ManageNewCKDPatientbalanceRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('collection-analysis-service-Location');
    }
