...
namespace App\Http\Requests\Backend\PracticeManagement;

use Illuminate\Foundation\Http\FormRequest;

class ManagePracticeManagementRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-practicemanagement');
    }
