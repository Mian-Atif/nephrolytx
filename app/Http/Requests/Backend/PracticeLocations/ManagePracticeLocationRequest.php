...
namespace App\Http\Requests\Backend\PracticeLocations;

use Illuminate\Foundation\Http\FormRequest;

class ManagePracticeLocationRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-practicelocation');
    }
