...
namespace App\Http\Requests\Backend\ActivePatientBalance;

use Illuminate\Foundation\Http\FormRequest;

class ManageActivePatientBalanceRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-activepatientbalance');
    }
