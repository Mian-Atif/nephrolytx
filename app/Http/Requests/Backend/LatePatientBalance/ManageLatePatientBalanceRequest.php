...
namespace App\Http\Requests\Backend\LatePatientBalance;

use Illuminate\Foundation\Http\FormRequest;

class ManageLatePatientBalanceRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('collection-analysis-by-service-type');
    }
