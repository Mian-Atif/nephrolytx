...
namespace App\Http\Requests\Backend\UploadReportsData;

use Illuminate\Foundation\Http\FormRequest;

class UpdateUploadReportsDatumRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('update-uploadreportsdatum');
    }
