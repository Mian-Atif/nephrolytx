...
namespace App\Http\Requests\Backend\ChequeReconciliationDetail;

use Illuminate\Foundation\Http\FormRequest;

class ManageChequeReconciliationDetailRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-chequereconciliationdetail');
    }
