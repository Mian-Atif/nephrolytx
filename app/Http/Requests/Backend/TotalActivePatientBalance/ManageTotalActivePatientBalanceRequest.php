...
namespace App\Http\Requests\Backend\TotalActivePatientBalance;

use Illuminate\Foundation\Http\FormRequest;

class ManageTotalActivePatientBalanceRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-totalactivepatientbalance');
    }
