...
namespace App\Http\Requests\Backend\CptCodeInsurancePrices;

use Illuminate\Foundation\Http\FormRequest;

class CreateCptCodeInsurancePriceRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('create-cptcodeinsuranceprice');
    }
