...
namespace App\Http\Requests\Backend\TransactionAnalysis;

use Illuminate\Foundation\Http\FormRequest;

class ManageTransactionAnalysiRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-transactionanalysi');
    }
