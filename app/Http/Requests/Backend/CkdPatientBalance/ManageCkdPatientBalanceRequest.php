...
namespace App\Http\Requests\Backend\CkdPatientBalance;

use Illuminate\Foundation\Http\FormRequest;

class ManageCkdPatientBalanceRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('charges-payments-analysis');
    }
