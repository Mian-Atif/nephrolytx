...
namespace App\Http\Requests\Backend\PerformanceReport;

use Illuminate\Foundation\Http\FormRequest;

class ManagePerformanceReportRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('manage-performancereport');
    }
