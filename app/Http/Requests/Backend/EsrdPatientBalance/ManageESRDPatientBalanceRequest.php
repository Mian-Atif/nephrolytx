...
namespace App\Http\Requests\Backend\EsrdPatientBalance;

use Illuminate\Foundation\Http\FormRequest;

class ManageESRDPatientBalanceRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('collection-analysis-provider');
    }
