...
namespace App\Http\Requests\Backend\PracticeUserManagement;

use Illuminate\Foundation\Http\FormRequest;

class CreatePracticeUserManagementRequest extends FormRequest
{
    /**
    ...
    {
        return access()->allow('create-practiceusermanagement');
    }
