...
//        $revenues=   array($ckdRevenue,$nonCkdRevenue,$esrdRevenue);
        ...
        $clinicalckdpatientsbmi =  DB::select('CALL clinical_ckd_patients_bmi(?,?,?,?)', [$practice_id, $location, $provider, $insurance]);
        //dd($clinicalckdpatientsbmi);

           $clinicalckdpatientsbmi1 = $clinicalckdpatientsbmi[0]->below_186;
           $clinicalckdpatientsbmi2 = $clinicalckdpatientsbmi[0]->rng_186_249;
           $clinicalckdpatientsbmi3 = $clinicalckdpatientsbmi[0]->rng_250_299;
           $clinicalckdpatientsbmi4 = $clinicalckdpatientsbmi[0]->equal_above_300;

           $clinicalckdpatientsbmistageESRD =  DB::select('CALL clinical_ckd_patients_bmi_stage_ESRD(?,?,?,?)', [$practice_id, $location, $provider, $insurance]);
            //dd($clinicalckdpatientsbmistageESRD);

            $clinicalckdpatientsbmistageESRD1 = $clinicalckdpatientsbmistageESRD[0]->below_186;
            $clinicalckdpatientsbmistageESRD2 = $clinicalckdpatientsbmistageESRD[0]->rng_186_249;
            $clinicalckdpatientsbmistageESRD3 = $clinicalckdpatientsbmistageESRD[0]->rng_250_349;
            $clinicalckdpatientsbmistageESRD4 = $clinicalckdpatientsbmistageESRD[0]->equal_above_350;
 
            $clinicalckdpatientsbmistage4 =  DB::select('CALL clinical_ckd_patients_bmi_stage_4(?,?,?,?)', [$practice_id, $location, $provider, $insurance]);
            //dd($clinicalckdpatientsbmistage4);

            $clinicalckdpatientsbmistage41 = $clinicalckdpatientsbmistage4[0]->below_186;
            $clinicalckdpatientsbmistage42 = $clinicalckdpatientsbmistage4[0]->rng_186_249;
            $clinicalckdpatientsbmistage43 = $clinicalckdpatientsbmistage4[0]->rng_250_349;
            $clinicalckdpatientsbmistage44 = $clinicalckdpatientsbmistage4[0]->equal_above_350;

            $clinicalckdpatientsbmistage5 =  DB::select('CALL clinical_ckd_patients_bmi_stage_5(?,?,?,?)', [$practice_id, $location, $provider, $insurance]);
            //dd($clinicalckdpatientsbmistage5);

            $clinicalckdpatientsbmistage51 = $clinicalckdpatientsbmistage5[0]->below_186;
            $clinicalckdpatientsbmistage52 = $clinicalckdpatientsbmistage5[0]->rng_186_249;
            $clinicalckdpatientsbmistage53 = $clinicalckdpatientsbmistage5[0]->rng_250_349;
            $clinicalckdpatientsbmistage54 = $clinicalckdpatientsbmistage5[0]->equal_above_350;
        // new View Api

       // $analysisController = new AnalysisController();

        return view('backend.ckd-pt-bmi', compact('newPatientAnalysisLabeles',
         'newPatientAnalysisTargets',
         'clinicalckdpatientsbmistage5',
         'clinicalckdpatientsbmistage51',
         'clinicalckdpatientsbmistage52',
         'clinicalckdpatientsbmistage53',
         'clinicalckdpatientsbmistage54',
         'clinicalckdpatientsbmistageESRD',
         'clinicalckdpatientsbmistage4',
         'clinicalckdpatientsbmistage41',
         'clinicalckdpatientsbmistage42',
         'clinicalckdpatientsbmistage43',
         'clinicalckdpatientsbmistage44',
         'clinicalckdpatientsbmistageESRD1',
         'clinicalckdpatientsbmistageESRD2',
         'clinicalckdpatientsbmistageESRD3',
         'clinicalckdpatientsbmistageESRD4',
         'clinicalckdpatientsbmi1',
         'clinicalckdpatientsbmi2',
         'clinicalckdpatientsbmi3',
         'clinicalckdpatientsbmi4',
         'clinicalckdpatientsbmi',
          'newPatientAnalysisAchieves', 
          'actualCollectionMix', 
          'actualCollectionMax', 
          'accountReceivablesStats', 'accountReceivables', 'collectionAndTargetCurrentMonth'
