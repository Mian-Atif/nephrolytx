...
class
OptimalStartsQuickTools extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.optimal-starts-quick-tools',compact('activePatientPerPhysicians','esrdPatientsPerPhysicians','newPatientsPerPhysicians','avgRevenuePerPhysiciansperDays','newPatientsActualMonths','activePatientsActualMonths'));
    }
