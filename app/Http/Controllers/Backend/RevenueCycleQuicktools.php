...
class
RevenueCycleQuicktools extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.revenue-cycle-quicktools',compact('activePatientPerPhysicians','esrdPatientsPerPhysicians','newPatientsPerPhysicians','avgRevenuePerPhysiciansperDays','newPatientsActualMonths','activePatientsActualMonths'));
    }
