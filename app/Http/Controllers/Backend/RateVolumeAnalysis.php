...
class RateVolumeAnalysis extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.rate-volume-analysis',compact('activePatientPerPhysicians','esrdPatientsPerPhysicians','newPatientsPerPhysicians','avgRevenuePerPhysiciansperDays','newPatientsActualMonths','activePatientsActualMonths'));
    }
