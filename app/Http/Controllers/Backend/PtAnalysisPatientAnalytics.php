...
class
PtAnalysisPatientAnalytics extends Controller
{
...
//        $revenues=   array($ckdRevenue,$nonCkdRevenue,$esrdRevenue);
        ...
        return view('backend.pt-analysis-patient-analytics', compact('newPatientAnalysisLabeles', 'newPatientAnalysisTargets', 'newPatientAnalysisAchieves', 'actualCollectionMix', 'actualCollectionMax', 'accountReceivablesStats', 'accountReceivables', 'collectionAndTargetCurrentMonth'
