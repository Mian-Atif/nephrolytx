<!--Action Button-->
@if( Active::checkUriPattern( 'admin/ckdpatientbalances' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.ckdpatientbalances.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.ckdpatientbalances.all' ) }}
            </a>
        </li>
