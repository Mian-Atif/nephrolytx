<!--Action Button-->
@if( Active::checkUriPattern( 'admin/activepatientbalances' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.activepatientbalances.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.activepatientbalances.all' ) }}
            </a>
        </li>
