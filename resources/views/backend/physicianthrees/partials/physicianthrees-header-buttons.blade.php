<!--Action Button-->
@if( Active::checkUriPattern( 'admin/physicianthrees' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.physician-three.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.physicianthrees.all' ) }}
            </a>
        </li>
