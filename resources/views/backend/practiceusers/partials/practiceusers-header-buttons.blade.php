<!--Action Button-->
@if( Active::checkUriPattern( 'admin/practiceusers' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.practiceusers.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.practiceusers.all' ) }}
            </a>
        </li>
        @permission( 'create-practiceuser' )
            <li>
                <a href="{{ route( 'admin.practiceusers.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.practiceusers.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
