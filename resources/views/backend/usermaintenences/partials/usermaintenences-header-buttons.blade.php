<!--Action Button-->
@if( Active::checkUriPattern( 'admin/usermaintenences' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.user-maintenences.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.usermaintenences.all' ) }}
            </a>
        </li>
