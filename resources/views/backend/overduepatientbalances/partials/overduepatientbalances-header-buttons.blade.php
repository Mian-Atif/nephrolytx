<!--Action Button-->
@if( Active::checkUriPattern( 'admin/overduepatientbalances' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.overduepatientbalances.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.overduepatientbalances.all' ) }}
            </a>
        </li>
