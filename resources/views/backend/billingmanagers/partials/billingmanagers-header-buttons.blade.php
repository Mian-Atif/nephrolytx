<!--Action Button-->
@if( Active::checkUriPattern( 'admin/billingmanagers' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.billingmanagers.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.billingmanagers.all' ) }}
            </a>
        </li>
        @permission( 'create-billingmanager' )
            <li>
                <a href="{{ route( 'admin.billingmanagers.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.billingmanagers.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
