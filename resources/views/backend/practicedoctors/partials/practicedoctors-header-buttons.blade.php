<!--Action Button-->
@if( Active::checkUriPattern( 'admin/practicedoctors' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.practicedoctors.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.practicedoctors.all' ) }}
            </a>
        </li>
        @permission( 'create-practicedoctor' )
            <li>
                <a href="{{ route( 'admin.practicedoctors.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.practicedoctors.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
