    ...
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card" style="border: none;">
                <div class="card-body">
                    <h4 class="card-title">Upload CPT Code Price </h4>
                    <form method="POST" action="{{ route('admin.cptcodes.store') }}" enctype="multipart/form-data" class="csvForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
    ...
    <script>
        $(document).ready(function () {
            $("#sample-csv").click(function () {
                axios({
                    url: '{{url('/cptcode-price-sample.csv')}}',
                    method: 'GET',
                    responseType: 'blob',
                }).then((response) => {
                    ...
                    fileLink.setAttribute('download', 'cptcode-price-sample.csv');
