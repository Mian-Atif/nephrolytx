<!--Action Button-->
@if( Active::checkUriPattern( 'admin/cptcodes' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.cptcodes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.cptcodes.all' ) }}
            </a>
        </li>
        @permission( 'create-cptcode' )
            <li>
                <a href="{{ route( 'admin.cptcodes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.cptcodes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
