<!--Action Button-->
@if( Active::checkUriPattern( 'admin/practiceprofiles' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.practiceprofiles.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.practiceprofiles.all' ) }}
            </a>
        </li>
